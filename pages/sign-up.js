export default function SignUp() {
    return (
        <div>
            <main className="flex flex-col py-4 items-center justify-center min-h-screen w-full">
                <section className="md:max-w-md w-full rounded-2xl py-12 px-10 border">
                    <header>
                        <h1>
                            <img src="/devchallenges.svg" />
                        </h1>
                        <h3 className="text-lg text-gray-6 font-semibold leading-tight mt-8">
                    ...
                    <div className="my-8">
                        <form method="POST">
                            <div className="mb-3">
                                <label className="flex items-center group border transition border-gray-5 p-2 focus-withins:border-gray-6 rounded-lg">
                                    <span>
